...
NEURON {
	...
	RANGE tau1m2, tau2m2
	RANGE tau1m5, tau2m5
	RANGE factora, factorn, factorm2, factorm5, initW
	RANGE Vmax, Kl
	RANGE L1, L2, L3
	RANGE Vm5, Vm2
	RANGE fm, fn
...
PARAMETER {
	Gn = 0.001 Ga = 0.12   :Gn = 0.01
	Vm5 = 0.25 Vm2 = 1    :Vm5 = 0.25
	...
	fcytbeta = 0.0035   ferratio = 0.015873   :fcytbeta = 1
	...
	dth = 0.3    pth = 0.6    :(uM), (uM)
	L1 = 0.5       L2 = 0.025    L3 = 0.05
...
:mGluR5 Ca2+ pool
	...
	w' = 0  : eta(can)*(L1*omegaN(can) - L3*(w-1)) + eta(cam/4)*(L2*omegaM(cam) - L3*(w-1))
