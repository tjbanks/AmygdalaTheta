...
def syn_percent_one_to_all(source, targets, p, track_list=None):
    """
    """
    global all_synapses
    sid = source.node_id
...
for p2p_prop in p2p_props:
    ...
    conn = net.add_edges(source={'pop_name': ['PyrA','PyrC']}, target={'pop_name': ['PyrA','PyrC']},
                iterator = 'one_to_one',
                #iterator = 'one_to_all',
                #connection_rule=syn_percent_one_to_all,
...
conn = net.add_edges(source={'pop_name': ['PyrA','PyrC']}, target={'pop_name': 'Bask'},
              iterator = 'one_to_one',
              connection_rule=syn_percent, #recurrent_connector,
