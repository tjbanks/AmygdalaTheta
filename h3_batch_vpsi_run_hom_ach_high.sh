...
{ printf "Start: $START \nEnd:   $END\n" & python analysis_hom.py --save-plots & printf "\n\n" & git diff components_homogenous/synaptic_models/; }| mail -r tbg28@mail.missouri.edu -s "AmygdalaTheta VPSI ACH High Simulation Results" -a analysis.png tbg28@mail.missouri.edu
