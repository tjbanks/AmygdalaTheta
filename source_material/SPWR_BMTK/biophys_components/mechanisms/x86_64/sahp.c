...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 sAHP /home/latimerb/SPWR_BMTK/biophys_components/mechanisms/modfiles/x86_64/sahp.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/latimerb/SPWR_BMTK/biophys_components/mechanisms/modfiles/sahp.mod";
static const char* nmodl_file_text = 
