...
#define nrn_init _nrn_init__interD2pyrD_STFD_alipara
#define _nrn_initial _nrn_initial__interD2pyrD_STFD_alipara
#define nrn_cur _nrn_cur__interD2pyrD_STFD_alipara
#define _nrn_current _nrn_current__interD2pyrD_STFD_alipara
#define nrn_jacob _nrn_jacob__interD2pyrD_STFD_alipara
#define nrn_state _nrn_state__interD2pyrD_STFD_alipara
#define _net_receive _net_receive__interD2pyrD_STFD_alipara 
#define release release__interD2pyrD_STFD_alipara 
...
#define DA2 DA2_interD2pyrD_STFD_alipara
#define DA1 DA1_interD2pyrD_STFD_alipara
#define GAP1 GAP1_interD2pyrD_STFD_alipara
#define NE2 NE2_interD2pyrD_STFD_alipara
#define NEn NEn_interD2pyrD_STFD_alipara
#define eta eta_interD2pyrD_STFD_alipara
#define omega omega_interD2pyrD_STFD_alipara
#define unirand unirand_interD2pyrD_STFD_alipara
...
#define Beta2 Beta2_interD2pyrD_STFD_alipara
 double Beta2 = 0.0001;
#define Beta1 Beta1_interD2pyrD_STFD_alipara
 double Beta1 = 0.001;
#define DA_S DA_S_interD2pyrD_STFD_alipara
 double DA_S = 1.6;
#define DA_t3 DA_t3_interD2pyrD_STFD_alipara
 double DA_t3 = 1.25;
#define DA_t2 DA_t2_interD2pyrD_STFD_alipara
 double DA_t2 = 1.5;
#define DA_t1 DA_t1_interD2pyrD_STFD_alipara
 double DA_t1 = 0.7;
#define DAstop2 DAstop2_interD2pyrD_STFD_alipara
 double DAstop2 = 36000;
#define DAstart2 DAstart2_interD2pyrD_STFD_alipara
 double DAstart2 = 35900;
#define DAstop1 DAstop1_interD2pyrD_STFD_alipara
 double DAstop1 = 40000;
#define DAstart1 DAstart1_interD2pyrD_STFD_alipara
 double DAstart1 = 39500;
#define GAPstop1 GAPstop1_interD2pyrD_STFD_alipara
 double GAPstop1 = 196000;
#define GAPstart1 GAPstart1_interD2pyrD_STFD_alipara
 double GAPstart1 = 96000;
#define NE_S NE_S_interD2pyrD_STFD_alipara
 double NE_S = 1;
#define NE_t3 NE_t3_interD2pyrD_STFD_alipara
 double NE_t3 = 1;
#define NE_t2 NE_t2_interD2pyrD_STFD_alipara
 double NE_t2 = 1;
#define NE_t1 NE_t1_interD2pyrD_STFD_alipara
 double NE_t1 = 1;
#define NEstop2 NEstop2_interD2pyrD_STFD_alipara
 double NEstop2 = 36000;
#define NEstart2 NEstart2_interD2pyrD_STFD_alipara
 double NEstart2 = 35900;
#define NEstop1 NEstop1_interD2pyrD_STFD_alipara
 double NEstop1 = 40000;
#define NEstart1 NEstart1_interD2pyrD_STFD_alipara
 double NEstart1 = 39500;
#define k k_interD2pyrD_STFD_alipara
 double k = 0.01;
 ...
 "Beta1_interD2pyrD_STFD_alipara", "/ms",
 "Beta2_interD2pyrD_STFD_alipara", "/ms",
 "srcid", "1",
 "destid", "1",
 "Cdur_gaba", "ms",
 "AlphaTmax_gaba", "/ms",
 ...
 "k_interD2pyrD_STFD_alipara", &k_interD2pyrD_STFD_alipara,
 "GAPstart1_interD2pyrD_STFD_alipara", &GAPstart1_interD2pyrD_STFD_alipara,
 "GAPstop1_interD2pyrD_STFD_alipara", &GAPstop1_interD2pyrD_STFD_alipara,
 "DAstart1_interD2pyrD_STFD_alipara", &DAstart1_interD2pyrD_STFD_alipara,
 "DAstop1_interD2pyrD_STFD_alipara", &DAstop1_interD2pyrD_STFD_alipara,
 "DAstart2_interD2pyrD_STFD_alipara", &DAstart2_interD2pyrD_STFD_alipara,
 "DAstop2_interD2pyrD_STFD_alipara", &DAstop2_interD2pyrD_STFD_alipara,
 "DA_t1_interD2pyrD_STFD_alipara", &DA_t1_interD2pyrD_STFD_alipara,
 "DA_t2_interD2pyrD_STFD_alipara", &DA_t2_interD2pyrD_STFD_alipara,
 "DA_t3_interD2pyrD_STFD_alipara", &DA_t3_interD2pyrD_STFD_alipara,
 "DA_S_interD2pyrD_STFD_alipara", &DA_S_interD2pyrD_STFD_alipara,
 "Beta1_interD2pyrD_STFD_alipara", &Beta1_interD2pyrD_STFD_alipara,
 "Beta2_interD2pyrD_STFD_alipara", &Beta2_interD2pyrD_STFD_alipara,
 "NEstart1_interD2pyrD_STFD_alipara", &NEstart1_interD2pyrD_STFD_alipara,
 "NEstop1_interD2pyrD_STFD_alipara", &NEstop1_interD2pyrD_STFD_alipara,
 "NEstart2_interD2pyrD_STFD_alipara", &NEstart2_interD2pyrD_STFD_alipara,
 "NEstop2_interD2pyrD_STFD_alipara", &NEstop2_interD2pyrD_STFD_alipara,
 "NE_t1_interD2pyrD_STFD_alipara", &NE_t1_interD2pyrD_STFD_alipara,
 "NE_t2_interD2pyrD_STFD_alipara", &NE_t2_interD2pyrD_STFD_alipara,
 "NE_t3_interD2pyrD_STFD_alipara", &NE_t3_interD2pyrD_STFD_alipara,
 "NE_S_interD2pyrD_STFD_alipara", &NE_S_interD2pyrD_STFD_alipara,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 void _interD2pyrD_STFD_new_alipara_reg() {
	int _vectorized = 0;
  _initlists();
 	ion_reg("ca", -10000.);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 interD2pyrD_STFD_alipara /home/tbg28/git_stage/nw_tyler/modfiles/x86_64/interD2pyrD_STFD_new_alipara.mod\n");
 ...
 v=_v;
{
  ...
  ica = _ion_ica;
 { error =  release();
 if(error){fprintf(stderr,"at line 183 in file interD2pyrD_STFD_new_alipara.mod:\n	 \n"); nrn_complain(_p); abort_run(error);}
 }}}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/tbg28/git_stage/nw_tyler/modfiles/interD2pyrD_STFD_new_alipara.mod";
static const char* nmodl_file_text = 
  ":Interneuron Cells to Pyramidal Cells GABA with local Ca2+ pool and read public soma Ca2+ pool\n"
  "\n"
  "NEURON {\n"
  "	POINT_PROCESS interD2pyrD_STFD_alipara\n"
