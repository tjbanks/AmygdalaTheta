...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 2, "pointer");
 	...
 	ivoc_help("help ?1 gap /home/tbg28/git_stage/nw_tyler/modfiles/x86_64/gap.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/tbg28/git_stage/nw_tyler/modfiles/gap.mod";
static const char* nmodl_file_text = 
  "NEURON {\n"
  "	POINT_PROCESS gap\n"
