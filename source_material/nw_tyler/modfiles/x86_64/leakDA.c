...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_prop_size(_mechtype, 5, 0);
 	...
 	ivoc_help("help ?1 leakDA /home/tbg28/git_stage/nw_tyler/modfiles/x86_64/leakDA.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/tbg28/git_stage/nw_tyler/modfiles/leakDA.mod";
static const char* nmodl_file_text = 
