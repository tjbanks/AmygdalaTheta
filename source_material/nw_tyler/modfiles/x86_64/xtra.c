...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 2, "area");
 	...
 	ivoc_help("help ?1 xtra /home/tbg28/git_stage/nw_tyler/modfiles/x86_64/xtra.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/tbg28/git_stage/nw_tyler/modfiles/xtra.mod";
static const char* nmodl_file_text = 
